        ...
        <Layout 
          header={
            ...
            <Searchbar 
              ...
              <Button variant={this.state.theme} onClick={this.changeTheme}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
          ...
          content={
            ...
            <Tables tables={this.state.tables} theme={this.state.theme} />
          )}
